...
namespace YB
{
    ...
    ////////////////////////////////////////////////////////////////////////////
        ...
        ~Keyboard() noexcept = default; /**< Default destructor */
    ...
    ////////////////////////////////////////////////////////////////////////////
        ...
        /// 
        void key_pressed(float delta_time_in_seconds) const;
    ...
    private:
        ...
        /// 
        void rotate_or_scale_key_pressed() const;

        /// 
        /// @brief Handles polygon mode change key presses.
        /// 
        void polygon_mode_change_key_pressed() const;

        /// 
        /// @brief Handles shader change key presses.
        /// 
        void shader_change_key_pressed() const;
