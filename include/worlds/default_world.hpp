...
namespace YB
{
    ...
    ////////////////////////////////////////////////////////////////////////////
        ...
        explicit DefaultWorld() noexcept = default; /**< Default constructor */
        ~DefaultWorld() noexcept override = default; /**< Default destructor */
    ...
    private:
        ...
        std::vector<Model3D> m_objs; ///< List of 3D models in the world.
