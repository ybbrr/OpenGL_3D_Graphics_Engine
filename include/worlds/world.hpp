...
namespace YB
{
    ...
    ////////////////////////////////////////////////////////////////////////////
        ...
        virtual ~World() noexcept = default; /**< Default virtual destructor */
    ...
    protected:
        ...
        float m_rotate_angle = 5.0f; ///< Initial rotate angle value for rotatable object
        float m_scale_factor = 0.0f; ///< Initial scale value for rotatable object
